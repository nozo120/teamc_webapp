...
export const handleRemit = async (req, res) => {
    try {
        ...
        const result = await dealing(Number(senderId), Number(receiverId), Number(amount));
...
//# sourceMappingURL=remitController.js.map